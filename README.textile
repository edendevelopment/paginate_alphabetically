...
To use alphanumeric functionality use neumeric => true

bc. class User < ActiveRecord::Base
  paginate_alphabetically :by => :surname, :neumeric => true
end
...
bc. = alphabetically_paginate(@users, :class => 'user-pagination', :neumeric => true)
